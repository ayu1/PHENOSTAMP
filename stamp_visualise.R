...
ccast_biaxialplot <- function(optccastreeoutput,ylabel,outputDir) {
...
ccast_tsne_plot2b <-function(x,y,vor,file1="Projection T-SNE plots2.tiff", sample="Tissue 2",window=NULL) {
    tiff(file="/home/xaliceyu/CCAST Biaxial plots%d.tiff",width=360, height=360)
    ##pdf(file="Biaxial T-SNE plots.pdf",width=10, height=10)
    if (is.null(window)){
